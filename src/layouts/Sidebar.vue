      ...
      <div class="nav accordion" id="accordionSidenav">
        ...
        <a class="nav-link d-sm-none" href="#!">
          <div class="nav-link-icon">
            <vue-feather type="bell" size="16"></vue-feather>
          </div>
          Alerts
          ...
          >
            ...
            >
              <nav class="sidenav-menu-nested nav">
                <routerLink class="nav-link" to="/app">Profile</routerLink>
            ...
            >
              <nav class="sidenav-menu-nested nav">
                ...
                <a class="nav-link" href="user-management-add-user.html"
                  >Add User</a
                >
                <a class="nav-link" href="user-management-groups-list.html"
                  >Groups List</a
                >
                <a class="nav-link" href="user-management-org-details.html"
            ...
            >
              <nav class="sidenav-menu-nested nav">
                <a class="nav-link" href="blog-management-posts-list.html"
                  >Posts List</a
                >
                <a class="nav-link" href="blog-management-create-post.html"
                  >Create Post</a
                >
                <a class="nav-link" href="blog-management-edit-post.html"
                  >Edit Post</a
                >
                <a class="nav-link" href="blog-management-posts-admin.html"
                  >Posts Admin</a
                >
              </nav>
            </div>
        ...
        >
          <div class="nav-link-icon">
            <vue-feather type="repeat" size="16"></vue-feather>
          </div>
          Flows
          <div class="sidenav-collapse-arrow">
            <i class="fas fa-angle-down"></i>
        ...
        >
          <div class="nav-link-icon">
            <vue-feather type="layout" size="16"></vue-feather>
          </div>
          Layout
          <div class="sidenav-collapse-arrow">
            <i class="fas fa-angle-down"></i>
        ...
        >
          <div class="nav-link-icon">
            <vue-feather type="package" size="16"></vue-feather>
          </div>
          Components
          <div class="sidenav-collapse-arrow">
            <i class="fas fa-angle-down"></i>
        ...
        >
          <div class="nav-link-icon">
            <vue-feather type="tool" size="16"></vue-feather>
          </div>
          Utilities
          <div class="sidenav-collapse-arrow">
            <i class="fas fa-angle-down"></i>
