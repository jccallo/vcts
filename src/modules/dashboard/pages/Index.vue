            ...
            <div class="row align-items-center justify-content-between">
               <div class="col">
                  <h2 class="text-primary">
                     ¡Bienvenido de nuevo, tu tablero está listo!
                  </h2>
                  <p class="text-gray-700">
                     ¡Buen trabajo, tu panel de afiliados está listo para
                     funcionar! Puede ver ventas, generar enlaces, preparar
                     cupones y descargar informes de afiliados utilizando este
                     panel.
                  </p>
               ...
               <div class="col d-none d-lg-block mt-xxl-n4">
                  <img
                     ...
                     src="../../../assets/img/illustrations/statistics.svg"
                  />
               </div>
            </div>
         </div>
