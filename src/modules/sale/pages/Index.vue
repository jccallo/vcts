...
import { Info, Pagination, StatusType } from '@/components'

const { data: sales, links, from, to, total, page, perpage, query, loadURL } = useDatatable<Sale>('/sales', 'sales.index')
         ...
         <div class="page-header-content">
            <div class="row align-items-center justify-content-between pt-3">
               ...
               <div class="col-12 col-xl-auto mb-3">
                  <routerLink class="btn btn-sm btn-light text-primary" :to="{ name: 'sales.create' }">
            ...
            <div class="datatable">
               ...
               <div class="table-responsive">
                  <table class="table table-bordered table-hover datatable-table">
                     ...
                     <tbody class="datatable-content">
                        <tr v-if="sales.length > 0" v-for="sale in sales" :key="sale.id">
               ...
               <div class="row">
                  <div class="col-xs-12 col-md-6 mb-sm-2 mb-md-0 pt-2">
                     <Info v-if="sales.length > 0" :from="from" :to="to" :total="total" />
                  </div>
                  <div class="col-xs-12 col-md-6 d-flex justify-content-md-end mb-0">
                     <Pagination :links="links" :page="page" :perpage="perpage" :query="query" route-name="sales.index" />
                  </div>
               </div>
            </div>
         </div>
