...
const { isLoading, customerForm, locations, errors, initWatchers, save } = useEdit()
         ...
         <div class="col">
            ...
            <div class="card mb-4">
               ...
               <div class="card-body">
                     ...
                     <div class="col-md-6">
                        <div class="mb-3">
                           ...
                           <v-select
                              ...
                              :class="{ 'jc-is-invalid': errors?.status }"
                              ...
                              label="name"
                           />
                           <span v-if="errors?.status" class="jc-invalid-feedback">
                              {{ errors?.status[0] }}
                           </span>
                        </div>
                     </div>
                  ...
                  <!-- Submit button-->
                  <button class="btn btn-primary" type="button" :disabled="isLoading" @click.prevent="save">Guardar cambios</button>
               </div>
            </div>
         </div>
      </div>
